...
class QuizPresenter {
  ...
  * a new quiz. The */
  ...
  /// Builds a quiz of 10 form 1 questions from the question database
  static QuizPresenter formOneBuilder() {
    // start the random number generator
    Random rng = Random();
    List<Question> questions = [];
    // decode json data into a map
    var jsonData = jsonDecode(form1Json);
    // get list of keys
    List<String> keys = jsonData.keys.toList();
    for (var i = 0; i < 10; i++) {
      // select a random key from keys
      int index = rng.nextInt(keys.length);
      // get the name from the key value at index
      String questionText = "What year was the name ${keys[index]} the most popular?";
      // Randomly generate the answers
      List<String> answers = [jsonData[keys[index]].toString(),
        (1880+rng.nextInt(2008-1880)).toString(),
        (1880+rng.nextInt(2008-1880)).toString(),
        (1880+rng.nextInt(2008-1880)).toString(),
        (1880+rng.nextInt(2008-1880)).toString()];
      // Shuffle the answers to increase the difficulty (suffering) for the user
      answers.shuffle();
      // Correct answer
      String answer = jsonData[keys[index]].toString();
      // add the question to questions
      questions.add(Question(questionText, answers, answer));
    }

    // Return the quizpresenter for the form 1 quiz
    return QuizPresenter(Quiz(questions));
  }
...
// tbh this is terrible but it works
String form1Json = '''{
    "John": "1988",
    "William": "1987",
    "James": "1989",
